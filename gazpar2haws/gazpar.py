...
class Gazpar:
    ...
    async def _publish_entity(self, entity_id: str, property_name: str, unit_of_measurement: str):
        ...
        last_date, last_days, last_value = await self._find_last_date_days_value(entity_id)
    ...
    # ----------------------------------
    # Find last date, days and value of the entity.
    async def _find_last_date_days_value(self, entity_id: str) -> tuple[datetime, int, float]:
        ...
        try:
            ...
            Logger.warning(f"Error while checking the existence of the sensor in Home Assistant: {traceback.format_exc()}")
            raise
        ...
        if exists_statistic_id:
            ...
            try:
                ...
                Logger.warning(f"Error while fetching last statistics from Home Assistant: {traceback.format_exc()}")
